package com.location.crud.api.rest.request;

public class LocationCrudCreateRequest {
    ...
    public static final class Builder {
        ...
        private LocationCrudCreateRequest objectBuild;

        private Builder() {
            this.objectBuild = new LocationCrudCreateRequest();
        }

        public LocationCrudCreateRequest build() {
            return objectBuild;
        }
